...
class Load(models.Model):
    ...
    customer_broker = models.ForeignKey('CustomerBroker', related_name='customer_broker', on_delete=models.CASCADE)
    ...
    truck = models.ForeignKey('Truck', related_name='truck', on_delete=models.CASCADE)
    dispatcher = models.ForeignKey('Dispatcher', related_name='created_by', on_delete=models.CASCADE)
    load_status = models.CharField(max_length=50, choices=LOAD_STATUS_CHOICES, blank=True, null=True)
    tags = models.ForeignKey('LoadTags', related_name='loadtags', on_delete=models.CASCADE)
